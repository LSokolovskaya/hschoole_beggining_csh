...
// }
// // На вход программе подается переменная date, в котрой лежит дата в формате 'xxxx-xx-xx'. Преобразуйте эту дату в формат 'xx/xx/xxxx’. (reverse)
...
// // Напишите программу по вводу числа с консоли и увеличения его на любое число (которое укажит программист), 
// // если результат больше 10.0, то выводится сообщение Число получилось больше 10!!!", в противном случае выводится Число всё же меньше 10грущу
// // System.Console.WriteLine("введите число");
// // int number = Convert.ToInt32 (Console.ReadLine());
// // number += 5;
// // if (number > 10.0)
// // {
// //     System.Console.WriteLine("Число получилось больше 10!!!");
// // }
// // else
// // {
// //     System.Console.WriteLine("Число всё же меньше 10грущу");
// // }

// // На вход подается строка. Необходимо добавить символ решетки (#) перед первым первым символ переданной строки создавая хештег.
// // Пример: hschool -> #hsch
// {
