...
//    //     Console.WriteLine($" Корени: {resoult2}, {resoult1}");     это второй вариант
// // else
...
// if (resoult < number1 * number2)
// {
//     Console.WriteLine("Неверно, попробуйте еще раз");
// }
// else if (resoult > number1 * number2)
// {
//     Console.WriteLine("Неверно, попробуйте еще раз");
// }
// else if (resoult == number1 * number2)
...
// Если число кратно двум, то ура, ели трем, то не совсем ура, в противном введите другое число
if (value % 2 == 0)
{
...
{
    Console.WriteLine("Не совсем ура!!!");
}
else
{
    Console.WriteLine(" введите другое число");
}
string result = value % 2 == 0 ? "Ура!!!" : value % 3 == 0 ? "Не совсем ура!!!" : " введите другое число";
...
value /= 2;
value = value / 2;
// еслим равно 1 то один если 0 то 0
if (value == 1)
{
    Console.WriteLine(1);
}
...
// {
// //если второе меньше
// // 0 найти модуль целой часть от деления первого числа на второе
// }
